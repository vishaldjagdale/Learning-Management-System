 ...
 export const searchCourse = async(req, res) => {
     ...
     // logic to add course to home screen which are published 
 ...
 export const editCourse = async(req, res) => {
     try {
         ...
         const thumbnail = req.file; // Assuming the file is passed as 'file'
         ...
         let courseThumbnail;
         if (thumbnail) {
             // If an existing thumbnail exists, delete it
         ...
         const updateData = {
             ...
             courseLevel,
             coursePrice,
             ...(courseThumbnail && { courseThumbnail }) // Only include if a new thumbnail was uploaded
         };
